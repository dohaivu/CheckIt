                ...
                Scaffold(
                    ...
                    myDayUiState.journalEditor?.let { editor ->
                        JournalEntryEditorSheet(
                            ...
                            onLabelSelected = viewModels.myDay::applyJournalLabel,
                            onPromptSelected = viewModels.myDay::applyJournalPrompt,
                            onPromptCleared = viewModels.myDay::clearJournalPrompt,
                            onDiscardDraft = viewModels.myDay::discardJournalDraft,
