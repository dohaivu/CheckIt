...
@Composable
internal fun ListSectionEditorSheet(
        ...
        LazyColumn(
            ...
            item {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = if (editor.mode == EditorMode.Add) "New section" else "Edit section",
                    ...
                    if (editor.mode == EditorMode.Edit) {
                        Box(
                            ...
                            IconButton(onClick = { menuExpanded = true }) {
                                Icon(Icons.Default.MoreVert, contentDescription = "Section options")
                            }
                            DropdownMenu(
    ...
    if (showDeleteConfirmation) {
        AlertDialog(
            ...
            text = { Text("Tasks and notes in this section will become unsectioned.") },
            confirmButton = {
                TextButton(
                    onClick = {
